                        ...
                        <ul class="flex flex-col gap-1">
                            @foreach ($menuGroup['items'] as $itemIndex => $item)
                                <li>
                                    ...
                                    @else
                                        @php
                                            $simplePath = $item['path'] ?? '';
                                            $simpleMenuActive =
                                                request()->path() === ltrim($simplePath, '/') ||
                                                (!empty($item['matchPathPrefix']) &&
                                                    str_starts_with(
                                                        request()->path(),
                                                        ltrim($item['matchPathPrefix'], '/'),
                                                    ));
                                        @endphp
                                        <!-- Simple Menu Item -->
                                        <a href="{{ $item['path'] }}" class="menu-item group"
                                            :class="[
                                                @json($simpleMenuActive) ? 'menu-item-active' :
                                                'menu-item-inactive',
                                            ...
                                            <!-- Icon -->
                                            <span
                                                :class="@json($simpleMenuActive) ? 'menu-item-icon-active' :
