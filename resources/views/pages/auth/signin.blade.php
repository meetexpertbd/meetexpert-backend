                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            @if (session('status'))
                                <p class="mt-3 text-sm text-green-600 dark:text-green-400">{{ session('status') }}</p>
                            @endif
                        </div>
                        <div>
                            ...
                            <form method="post" action="{{ route('login') }}" class="space-y-5">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="info@gmail.com" required autocomplete="username"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: false }">
                                            <label for="checkboxLabelOne"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" name="remember" value="1" id="checkboxLabelOne" class="sr-only" @change="checkboxToggle = !checkboxToggle" />
