                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input type="text" id="fname" name="fname" value="{{ old('fname') }}"
                                            ...
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('fname') border-error-500 @else border-gray-300 @enderror" />
                                        @error('fname')
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input type="text" id="lname" name="lname" value="{{ old('lname') }}"
                                            ...
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('lname') border-error-500 @else border-gray-300 @enderror" />
                                        @error('lname')
                                            <p class="mt-1 text-sm text-error-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" required autocomplete="email"
                                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('email') border-error-500 @else border-gray-300 @enderror" />
                                    @error('email')
                                        <p class="mt-1 text-sm text-error-500">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" name="password" id="password" placeholder="Enter your password" required autocomplete="new-password"
                                ...
                                <div>
                                    <div x-data="{ checkboxToggle: {{ old('terms') ? 'true' : 'false' }} }">
                                        <label for="checkboxLabelOne"
                                            ...
                                            <div class="relative">
                                                <input type="checkbox" name="terms" value="1" id="checkboxLabelOne" class="sr-only" {{ old('terms') ? 'checked' : '' }} @change="checkboxToggle = !checkboxToggle" />
